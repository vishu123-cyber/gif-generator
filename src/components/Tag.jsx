    ...
    return(
     <section className="w-full overflow-hidden rounded-2xl border border-blue-700/20 bg-blue-500 p-4 shadow-xl shadow-blue-900/15 sm:p-6">
            <div className="flex min-h-[26rem] flex-col items-center gap-5">
              ...
              <input type="text" placeholder="Enter a tag" className="w-full rounded-xl border border-transparent bg-white px-4 py-3 font-medium text-slate-900 outline-none transition placeholder:text-slate-500 focus:border-blue-900 focus:ring-4 focus:ring-white/50 sm:w-10/12" />
